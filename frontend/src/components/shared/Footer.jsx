...
//               <li><a href="/faq#how-to-apply" className="hover:text-gray-400">How to apply for a job?</a></li>
//               <li><a href="/faq#resume-upload" className="hover:text-gray-400">How to upload my resume?</a></li>
//               <li><a href="/faq#employer-contact" className="hover:text-gray-400">How do employers contact me?</a></li>
//               <li><a href="/faq#profile-update" className="hover:text-gray-400">How to update my profile?</a></li>
//             </ul>
//           </div> */}
...
//             </a>
//             <a href="https://x.com/i/flow/single_sign_on" className="hover:text-gray-400" aria-label="Twitter">
